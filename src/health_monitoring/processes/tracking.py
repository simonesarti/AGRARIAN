...
from src.health_monitoring.tracking.detection import postprocess_tracking_results
...
if not logger.handlers:  # Avoid duplicate handlers
    video_handler = logging.FileHandler('./logs/animals_tracking.log', mode='w')
...
class TrackerWorker(mp.Process):
    """
    TrackerWorker is a standalone process that:
    - Instantiates the tracker once during initialization
    - Stores 'tracking_args' for consistent use
